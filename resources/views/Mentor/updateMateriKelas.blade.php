        ...
        <div class="card-body">
            <div class="container">
                <form action="{{route('Store-Update-Materi-Kelas', $id->id)}}" method="POST">
                    ...
                    <br>
                    <button  type="submit" class="btn btn-block btn-lg btn-outline-primary tambahmateri"><i class="fas fa-plus"></i> Tambah Materi</button>
                </form>
            </div>
        </div>
    </div>
...
<script src="{{asset('js/sweetalert2.min.js')}}"></script>
  ...
  $(".hapusKelas").click(function(e){
            ...
            Swal.fire({
                    ...
                    text: "Jika Iya Maka Materi Ini akan di Hapus Secara Permanen!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
