...
<div class="row">
    <div class="col-12 col-md-6 order-md-1 order-last">
        <h3>Create Kelas <span style="font-size: 15px" class="btn-outline-primary p-1 rounded">Premium <i class="fas fa-star text-warning"></i></span></h3>
...
<section class="section">
    <div class="card">
        ...
        <div class="card-body">
            <div class="container">
                <form action="{{route('Store-Kelas-Premium')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="input-body">
                        <input type="text" readonly name="status_kelas" value="Premium" id="status_kelas" class="form-control ">
                    </div>
                    <br>
                    <div class="input-header">
                    ...
                    <div class="input-body">
                        <input type="text" name="harga_diskon" id="harga_diskon" class="form-control  @error('harga_diskon') is-invalid @enderror ">
