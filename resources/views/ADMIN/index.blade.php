...
<section class="row">
                ...
                <div class="card">
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <h6 class="text-muted font-semibold">Visit Web</h6>
                               
                                <h6 class="font-extrabold mb-0">{{number_format($visit)}}</h6>  
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h6 class="font-extrabold mb-0">{{number_format($user)}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-12 col-lg-3">
        ...
        <div class="card">
            <div class="card-header" id="chart-profile-visit">
