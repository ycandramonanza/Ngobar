@extends('MasterAdmin')
@section('tittle')
<title>Table-Mentor-Nonaktif</title>
        ...
        <table class="table table-striped" id="table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form>
                        <button type="button" class="btn btn-danger status-akun"  data-name ="{{$item->name}}" data-status = "{{$item->status}}" data-images="{{asset('Pavicon/user.png')}}" data-bergabung = "{{$item->cvmentor->updated_at->format('d-m-Y')}}" ><i class="far fa-user-circle"></i></button>
                       </form>
                    </td>
