...
<head>
  ...
  <title>Admin Login Ngobar.com</title>
          ...
          <div class="login-wrapper my-auto">
            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="form-group mb-4">
                ...
                <input type="password" name="password" id="password" class="form-control  @error('password') is-invalid @enderror" placeholder="Maukan Password ">
                @error('password')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <p class="login-wrapper-footer-text">Kamu Belum Memiliki Akun? <a href="{{ route('register') }}" class="text-reset">Buat Disini</a></p>
          </div>
        </div>
